...
const Signup = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?q=80&w=2000&auto=format')",
    ...
    >
      ...
      <motion.div
        ...
        className="mt-8 z-10"
      >
        <Link to="/" className="text-white hover:text-indigo-300 transition-colors flex items-center gap-1">
          &larr; Back to home
        </Link>
      </motion.div>
    </div>
